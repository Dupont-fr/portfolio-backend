...
function confirmationContent(data: MessageInput): string {
  return `
    ${brandBlock()}
...
function notificationContent(data: MessageInput): string {
  return `
    ${brandBlock()}
...
export async function sendConfirmationEmail(data: MessageInput): Promise<void> {
...
function replyContent(data: ReplyEmailInput): string {
  return `
    ${brandBlock()}
...
export async function sendReplyEmail(data: ReplyEmailInput): Promise<void> {
